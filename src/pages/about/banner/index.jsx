...
drop-shadow-2xl h-fit text-transparent bg-gradient-to-r from-blue-500 via-gray-50 to-purple-500 bg-clip-text"
      >
        ABOUT US
      </motion.h3>
      <img
     ...
     lg:h-full hidden lg:block lg:object-cover -top-8 absolute right-0  2xl:-right-4 "
      ...
      >
        <img
          ...
          width={600}
          height={814}
          className="h-[450px] w-[350px] lg:w-[600px] lg:h-full lg:object-cover -top-8"
        />
      </motion.div>
    </div>
  );
